...
const navigation = [
    { name: 'Dashboard', href: '/Dashboard', current: window.location.href.indexOf('record') > -1 ? true : false },
    { name: 'Verify', href: '/Verify', current: window.location.href.indexOf('verify') > -1 ? true : false },
];
                                ...
                                <div className="flex h-20 items-center justify-between">
                                    <div className="flex items-center">
                                        <div className="text-left font-bold">
                                            <img src="Frame.png" alt="Frame" className="inline-block mr-2" height="200px" width="200px" />
                                        </div>
                                    </div>
                                    ...
                                    <nav className="flex-1 bg-white space-y-1">
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                href={item.href}
                                                className={classNames(
                                                    item.current ? 'bg-blue-500 text-white' : 'text-black-300 hover:bg-blue-700 hover:text-white',
